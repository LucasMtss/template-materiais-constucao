...
import cover4 from '../assets/products/cover/4.jpg'
import cover5 from '../assets/products/cover/5.jpg'
import cover6 from '../assets/products/cover/6.jpg'
import cover7 from '../assets/products/cover/8.jpg'
    ...
    return (
        <div className="flex-1 max-w-[800px] mx-auto">
            ...
            <div className="flex flex-col p-5 mt-2 flex-1">
                ...
                <span className="text-green-600 text-2xl font-heading my-2">{formatCurrency(product?.price ?? 0)}</span>
